...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        edi.DeviceCollector.OnloadDevice   += DeviceManager_OnloadDeviceAsync;
        edi.DeviceCollector.OnUnloadDevice += DeviceManager_OnUnloadDevice;
    ...
    private void Variants_SelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
        if (sender is ComboBox cb && cb.DataContext is IDevice device && cb.SelectedItem is string variant)
            edi.DeviceConfiguration.SelectVariant(device, variant);
    }
    ...
    private async void btnStop_Click(object? sender, RoutedEventArgs e)   => await edi.Player.Stop();
    private async void btnPause_Click(object? sender, RoutedEventArgs e)  => await edi.Player.Pause();
    private async void btnResume_Click(object? sender, RoutedEventArgs e) => await edi.Player.Resume(false);
